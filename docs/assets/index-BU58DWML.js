import { r as w, _ as G, j as m, c as Ma, a as tt, u as za, b as N, g as ql, d as $l, G as Fa, B as lt, A as Vl, C as Ul, e as La, P as Wl, K as Xl, E as Kl, f as Ba, h as Ha, i as ct, k as $n, S as Gl, s as Yl, l as Mn, m as bt, n as qa, o as $a, T as Va, t as Ql, p as Jl, q as Ua, R as Ne, z as zn, N as fe, L as Zl, v as Wi, w as es, x as ts, y as ns, M as is, D as rs, F as as, H as os, I as ls, J as ss, O as cs, __tla as __tla_0 } from "./index-C_yu0sIe.js";
let Gg;
let __tla = Promise.all([
  ...
  var Wa = [
    ...
    "details:not([inert])"
  ], Cn = Wa.join(","), Xa = typeof Element > "u", yt = Xa ? function() {
  } : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector, On = !Xa && Element.prototype.getRootNode ? function(e) {
    var t;
    ...
    return n && yt.call(t, Cn) && r.unshift(t), r = r.filter(i), r;
  }, Ga = function e(t, n, i) {
    ...
    return t.tabIndex < 0 && (/^(AUDIO|VIDEO|DETAILS)$/.test(t.tagName) || us(t)) && !Ya(t) ? 0 : t.tabIndex;
  }, ps = function(t, n) {
    var i = gt(t);
    return i < 0 && n && !Ya(t) ? 0 : i;
  }, ds = function(t, n) {
    ...
    var a = yt.call(t, "details>summary:first-of-type"), o = a ? t.parentElement : t;
    if (yt.call(o, "details:not([open]) *")) return true;
    ...
    if (/^(INPUT|BUTTON|SELECT|TEXTAREA)$/.test(t.tagName)) for (var n = t.parentElement; n; ) {
      if (n.tagName === "FIELDSET" && n.disabled) {
        for (var i = 0; i < n.children.length; i++) {
          ...
          if (r.tagName === "LEGEND") return yt.call(n, "fieldset[disabled] *") ? true : !r.contains(t);
        }
        return true;
      }
      n = n.parentElement;
    ...
    return n.getShadowRoot ? i = Ga([
      ...
      shadowRootFilter: ks
    }) : i = Ka(t, n.includeContainer, wi.bind(null, n)), Cs(i);
  }, Ss = function(t, n) {
    n = n || {};
    var i;
    return n.getShadowRoot ? i = Ga([
      ...
      flatten: true,
      getShadowRoot: n.getShadowRoot
    }) : i = Ka(t, n.includeContainer, _n.bind(null, n)), i;
  }, kt = function(t, n) {
    if (n = n || {}, !t) throw new Error("No node provided");
    return yt.call(t, Cn) === false ? false : wi(n, t);
  }, _s = Wa.concat("iframe").join(","), Vn = function(t, n) {
    if (n = n || {}, !t) throw new Error("No node provided");
    return yt.call(t, _s) === false ? false : _n(n, t);
  };
  function ki(e, t) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var yr = {
    ...
    var i = (n == null ? void 0 : n.document) || document, r = (n == null ? void 0 : n.trapStack) || Ls, a = vr({
      ...
      if (o.tabbableGroups.length > 0) {
        ...
        if (H < 0) $ ? X = o.tabbableGroups[o.tabbableGroups.length - 1].lastTabbableNode : X = o.tabbableGroups[0].firstTabbableNode;
          ...
          var W = o.tabbableGroups.findIndex(function(_e) {
            var xe = _e.firstTabbableNode;
            return v === xe;
          });
          if (W < 0 && (h.container === v || Vn(v, a.tabbableOptions) && !kt(v, a.tabbableOptions) && !h.nextTabbableNode(v, false)) && (W = H), W >= 0) {
          ...
          var Y = o.tabbableGroups.findIndex(function(_e) {
            var xe = _e.lastTabbableNode;
            return v === xe;
          });
          if (Y < 0 && (h.container === v || Vn(v, a.tabbableOptions) && !kt(v, a.tabbableOptions) && !h.nextTabbableNode(v)) && (Y = H), Y >= 0) {
      ...
      if (o.active) return yr.activateTrap(r, l), o.delayInitialFocusTimer = a.delayInitialFocus ? br(function() {
        y(p());
      }) : y(p()), i.addEventListener("focusin", E, true), i.addEventListener("mousedown", C, {
        capture: true,
        passive: false
      ...
      if (o.active) return i.removeEventListener("focusin", E, true), i.removeEventListener("mousedown", C, true), i.removeEventListener("touchstart", C, true), i.removeEventListener("click", O, true), i.removeEventListener("keydown", A, true), i.removeEventListener("keydown", q), l;
    }, D = function(x) {
  ...
  const Ja = (e, t, n) => {
    ...
    var { children: t, id: n = "", className: i, component: r = "div", isCompact: a = false, isSelectable: o = false, isClickable: l = false, isDisabled: c = false, isSelected: s = false, isClicked: u = false, isExpanded: p = false, isLarge: f = false, isFullHeight: d = false, isPlain: y = false, variant: k = "default", ouiaId: _, ouiaSafe: C = true } = e, E = G(e, [
      "children",
      "id",
      "className",
      "component",
    ...
    const T = r, A = za(Gi.displayName, _, C);
  ...
  class It extends w.Component {
    ...
    render() {
      const t = this.props, { "aria-label": n, checked: i, className: r, inputClassName: a, defaultChecked: o, isLabelWrapped: l, labelPosition: c = "end", isChecked: s, isDisabled: u, isValid: p, label: f, onChange: d, description: y, body: k, ouiaId: _, ouiaSafe: C = true, component: E } = t, T = G(t, [
        "aria-label",
        "checked",
        "className",
        "inputClassName",
      ...
      const A = m.jsx("input", Object.assign({}, T, {
        ...
        "aria-label": n
      }, $l(It.displayName, _ !== void 0 ? _ : this.state.ouiaStateId, C))), q = l && !E || E === "label", O = q ? "span" : "label", L = f ? m.jsx(O, {
        className: N(ht.radioLabel, u && ht.modifiers.disabled),
        htmlFor: q ? void 0 : T.id,
        children: f
      }) : null, V = E ?? (q ? "label" : "div");
      return m.jsxs(V, {
  ...
  const ao = (e) => {
    ...
    return m.jsx(Fa, {
      children: (p) => m.jsx(Ki.Consumer, {
        children: ({ cardId: f, isClickable: d, isSelectable: y, isSelected: k, isDisabled: _ }) => {
          const C = m.jsx("div", {
          ...
          (i == null ? void 0 : i.actions) && E && console.error(`Card: ${d ? "Clickable" : "Selectable"} only cards should not contain any other actions. If you wish to include additional actions, use a clickable and selectable card.`);
          const T = d && !y;
          ...
          const A = (r == null ? void 0 : r.variant) === "single" ? It : Ul, q = () => {
            ...
            const M = Object.assign({
              className: N("pf-v6-c-card__clickable-action", _ && O && pe.modifiers.disabled, (r == null ? void 0 : r.isHidden) && "pf-v6-screen-reader"),
  ...
  const Us = {
    ...
    return m.jsx(p, Object.assign({}, f, s, {
      ...
      className: N(Us[u], d && r && Oe.modifiers.plain, a && Oe.modifiers.visited, c && Oe.modifiers.editorial, n),
      children: t
    }));
  };
  ...
  const Xs = {
    ...
    const g = z || La(), Y = a !== null, [ce, ne] = w.useState(false), [_e, xe] = w.useState(!!$), ve = w.useRef(null);
    w.useEffect(() => {
      O();
    }, []), w.useEffect(() => {
    ...
    const me = (P, b) => {
      ...
      className: N(de.popover, d && Xs[d], H && de.modifiers.noPadding, h && de.modifiers.widthAuto, r),
      role: "dialog",
      "aria-modal": "true",
  ...
  const Ys = {
    ...
    const s = i, u = r !== "default", p = u && Ys[r], f = u && l && l !== "";
  ...
  const wo = (e) => {
    ...
    const _ = w.useRef(void 0), C = w.useRef(void 0), [E, T] = w.useState(0), { position: A, isExpanded: q, isStatic: O, onExpand: L, drawerRef: V, drawerContentRef: D, isInline: M } = w.useContext(Qi), F = O ? false : !q, [I, x] = w.useState(!F), [v, S] = w.useState(false), z = w.useRef(null);
    ...
    const g = () => {
      ...
      J && (X = _.current.getBoundingClientRect(), oe ? (h = X.right, H = X.left) : (H = X.right, h = X.left), W = X.bottom, J = false);
      const Ee = ae;
      let Ce = 0;
      A === "end" || A === "right" ? Ce = oe ? Ee - H : H - Ee : A === "start" || A === "left" ? Ce = oe ? h - Ee : Ee - h : Ce = W - Ee, A === "bottom" && (_.current.style.overflowAnchor = "none"), _.current.style.setProperty(Kn.name, Ce + "px"), $ = Ce, T(g());
    }, ve = (K) => {
    ...
    }, le = w.useCallback(ne, []), Te = w.useCallback(me, []), ze = w.useCallback(_e, []), qe = w.useCallback(ve, []), Ge = (K) => {
      const ae = $n(_.current) === "rtl", oe = K.key;
      ...
      zt = A === "bottom" ? Ee.height : Ee.width;
      let Ce = 0;
      oe === "ArrowRight" ? ae ? Ce = A === "left" || A === "start" ? -u : u : Ce = A === "left" || A === "start" ? u : -u : oe === "ArrowLeft" ? ae ? Ce = A === "left" || A === "start" ? u : -u : Ce = A === "left" || A === "start" ? -u : u : oe === "ArrowUp" ? Ce = u : oe === "ArrowDown" && (Ce = -u), zt = zt + Ce, A === "bottom" && (_.current.style.overflowAnchor = "none"), _.current.style.setProperty(Kn.name, zt + "px"), $ = zt, T(g());
    }, Ae = {};
    c && (Ae[Kn.name] = c), l && (Ae[Qs.name] = l), s && (Ae[Js.name] = s);
    ...
    return m.jsx(Fa, {
      ...
      children: (K) => {
        ...
        return m.jsx($e, Object.assign({}, we && ae, {
          ...
          onTransitionEnd: (oe) => {
            oe.target === _.current && (!F && oe.nativeEvent.propertyName === "transform" && L(oe), x(!F), we && oe.nativeEvent.propertyName === "transform" && S((Ee) => !Ee));
          },
          hidden: F
        }, (c || l || s) && {
          style: Ae
  ...
  Ei.displayName = "EmptyStateFooter";
  const vn = (e) => {
    var { children: t, className: n } = e, i = G(e, [
      "children",
      "className"
  ...
  var Er;
  function ic() {
    return Er || (Er = 1, Gn.exports = nc()()), Gn.exports;
  }
  var rc = ic();
  const ge = Mn(rc), ac = /* @__PURE__ */ new Map([
    [
      "1km",
  ...
  function Pt(e, t, n) {
    const i = oc(e), { webkitRelativePath: r } = e, a = typeof t == "string" ? t : typeof r == "string" && r.length > 0 ? r : `./${e.name}`;
    return typeof i.path != "string" && jr(i, "path", a), jr(i, "relativePath", a), i;
  }
  function oc(e) {
    const { name: t } = e;
    if (t && t.lastIndexOf(".") !== -1 && !e.type) {
      const i = t.split(".").pop().toLowerCase(), r = ac.get(i);
  ...
  function sc(e) {
    return bt(this, void 0, void 0, function* () {
      return En(e) && cc(e.dataTransfer) ? fc(e.dataTransfer, e.type) : uc(e) ? pc(e) : Array.isArray(e) && e.every((t) => "getFile" in t && typeof t.getFile == "function") ? dc(e) : [];
    });
  }
  function cc(e) {
    return En(e);
  ...
  function fc(e, t) {
    return bt(this, void 0, void 0, function* () {
      if (e.items) {
        ...
        if (t !== "drop") return n;
        const i = yield Promise.all(n.map(mc));
        return Tr(So(i));
      }
  ...
  function Tr(e) {
    return e.filter((t) => lc.indexOf(t.name) === -1);
  }
  function ji(e) {
    if (e === null) return [];
    const t = [];
  ...
  function mc(e) {
    ...
    return t && t.isDirectory ? _o(t) : Ir(e, t);
  }
  function So(e) {
    return e.reduce((t, n) => [
      ...t,
  ...
  function hc(e) {
    return bt(this, void 0, void 0, function* () {
      return e.isDirectory ? _o(e) : gc(e);
    });
  }
  function _o(e) {
    ...
    return new Promise((n, i) => {
      const r = [];
      function a() {
        t.readEntries((o) => bt(this, void 0, void 0, function* () {
          if (o.length) {
            const l = Promise.all(o.map(hc));
            r.push(l), a();
          } else try {
  ...
  const Jn = Mn(vc), yc = {
    ...
    height: null,
    getBreakpoint: $a,
    getVerticalBreakpoint: qa
  }, Nt = w.createContext(wc), kc = Nt.Provider;
  Nt.Consumer;
  const Eo = (e) => {
  ...
  class Kt extends w.Component {
    constructor() {
      super(...arguments), this.id = this.props.id || La();
    }
    render() {
      const t = this.props, { id: n, size: i, className: r, value: a, title: o, label: l, variant: c, measureLocation: s, min: u, max: p, valueText: f, isTitleTruncated: d, tooltipPosition: y, "aria-label": k, "aria-labelledby": _, helperText: C } = t, E = G(t, [
        "id",
        "size",
        "className",
        "value",
      ...
      (o || _) && (T["aria-labelledby"] = o ? `${this.id}-description` : _), k && (T["aria-label"] = k), f && (T["aria-valuetext"] = f), !o && !_ && !k && console.warn("One of aria-label or aria-labelledby properties should be passed when using the progress component without a title.");
      const A = Math.min(100, Math.max(0, Math.floor((a - u) / (p - u) * 100))) || 0;
      return m.jsx("div", Object.assign({}, E, {
  ...
  class Ji extends w.Component {
    ...
    componentDidMount() {
      ...
      if (t || n) {
        this.observer = Ja(this.pageRef.current, this.handleResize);
  ...
  const Cc = {
    ...
    var { className: t = "", children: n, variant: i = "default", type: r = "default", padding: a, isFilled: o, isWidthLimited: l = false, isCenterAligned: c = false, stickyOnBreakpoint: s, hasShadowTop: u = false, hasShadowBottom: p = false, hasOverflowScroll: f = false, "aria-label": d, component: y = "section", hasBodyWrapper: k = true } = e, _ = G(e, [
      "className",
      "children",
      "variant",
      "type",
    ...
    const { height: C, getVerticalBreakpoint: E } = w.useContext(Nt);
    w.useEffect(() => {
    ...
    const T = y;
    return m.jsx(T, Object.assign({}, _, {
      className: N(Cc[r], ct(a, ie), ct(s, ie, "sticky-", E(C), true), r === ot.default && Oc[i], o === false && ie.modifiers.noFill, o === true && ie.modifiers.fill, l && ie.modifiers.limitWidth, l && c && r !== ot.subNav && ie.modifiers.alignCenter, u && ie.modifiers.shadowTop, p && ie.modifiers.shadowBottom, f && ie.modifiers.overflowScroll, t)
    }, f && {
      tabIndex: 0
    }, {
      "aria-label": d,
  ...
  const Fo = {
    ...
    return Object.entries(Tn).forEach(([p, f]) => {
      ...
      style: l || o ? Object.assign(Object.assign({}, l), Ua(o, Fo.name)) : void 0
    }, c, {
      children: t
    }));
  };
  ...
  const Ii = (e) => {
    ...
    return Object.entries(Tn).forEach(([f, d]) => {
      const y = f, k = `${y}RowSpan`, _ = `${y}Offset`, C = s[y], E = s[k], T = s[_];
      C && u.push(et.modifiers[`${C}ColOn${d}`]), E && u.push(et.modifiers[`${E}RowOn${d}`]), T && u.push(et.modifiers[`offset_${T}ColOn${d}`]), delete s[y], delete s[k], delete s[_];
    }), m.jsx(p, Object.assign({
      className: N(...u, n),
      style: c || l ? Object.assign(Object.assign({}, c), Ua(l, Fo.name)) : void 0
    }, s, {
      children: t
    }));
  };
  ...
  function Zi(e, t) {
    ...
    return n.eachBefore(Vc);
  }
  function Bc() {
    return Zi(this).eachBefore($c);
  }
  function Hc(e) {
    return e.children;
  }
  ...
  function Yc() {
    var e = Uc, t = 1, n = 1, i = null;
    function r(s) {
      var u = Gc(s);
      if (u.eachAfter(a), u.parent.m = -u.z, u.eachBefore(o), i) s.eachBefore(c);
      else {
        var p = s, f = s, d = s;
        s.eachBefore(function(E) {
          E.x < p.x && (p = E), E.x > f.x && (f = E), E.depth > d.depth && (d = E);
        });
        var y = p === f ? 1 : e(p, f) / 2, k = y - p.x, _ = t / (f.x + y + k), C = n / (d.depth || 1);
        s.eachBefore(function(E) {
          E.x = (E.x + k) * _, E.y = E.depth * C;
        });
      }
      return s;
    }
    ...
    function l(s, u, p) {
      if (u) {
        for (var f = s, d = s, y = u, k = f.parent.children[0], _ = f.m, C = d.m, E = y.m, T = k.m, A; y = ei(y), f = Zn(f), y && f; ) k = Zn(k), d = ei(d), d.a = s, A = y.z + E - f.z - _ + e(y._, f._), A > 0 && (Wc(Kc(y, s, p), s, A), _ += A, C += A), E += y.m, _ += f.m, T += k.m, C += d.m;
        y && !ei(d) && (d.t = y, d.m += E - C), f && !Zn(k) && (k.t = f, k.m += _ - T, p = s);
      }
      return p;
    }
    function c(s) {
  ...
  function Qc(e) {
    const t = e.margins || {
      ...
      top: 10
    }, n = e.width - t.left - t.right, i = e.height - t.top - t.bottom, r = Zi(e.data, e.getChildren), a = Yc().size([
      i,
      n
    ])(r), o = a.links().map((c) => ({
      ...c,
  ...
  function bn(e, ...t) {
    const i = Object.keys(e).filter((r) => Jc.test(r) && typeof e[r] == "function").reduce((r, a) => (r[a] = Zc(e[a], t), r), {});
    return {
      ...e,
      ...i
    };
  ...
  function tu(e) {
    const t = bn(e.pathProps, e.source.data[e.keyProp], e.target.data[e.keyProp]), i = (e.pathFunc || eu)(e.x1, e.y1, e.x2, e.y2);
  ...
  function iu(e) {
    ...
    }, e.links.map((t) => Ne.createElement(tu, {
    ...
    })), e.nodes.map((t) => Ne.createElement(nu, st({
  ...
  function $t(e, t = "root") {
    return zn(e).with({
      ...
      Ct(t, "X", n.flatMap((i, r) => $t(i, t + ".X+" + r)))
    ]).with({
      plus: fe.array()
    }, ({ plus: n }) => [
      Ct(t, "+", n.flatMap((i, r) => $t(i, t + ".+" + r)))
    ]).exhaustive();
  }
  const au = {
    width: nn,
...
`, ti = [
    {
      ...
      value: du.replace(/\{n\}/g, "4").replace(/\{model\}/g, "model").replace(/\{temperature\}/g, "0.2").replace(/\{max_tokens\}/g, "100")
    },
    {
      ...
      value: fu.replace(/\{n\}/g, "4").replace(/\{model\}/g, "model").replace(/\{temperature\}/g, "0.2").replace(/\{max_tokens\}/g, "100")
    },
    {
      label: "Policy-driven Email Generation",
      description: "This demonstrates using policies to guide email generation",
      value: mu.replace(/\{n\}/g, "4").replace(/\{model\}/g, "model").replace(/\{temperature\}/g, "0.2").replace(/\{max_tokens\}/g, "100")
    }
  ];
  function hu() {
    const [e, t] = w.useState(false), [n, i] = Wi("spnl.demo.select", {
      defaultValue: ti[0].value
    }), r = () => {
      t(!e);
    }, a = (l, c) => {
      i(c), t(false);
      ...
      onClick: r,
      isExpanded: e,
      children: (ti.find((c) => c.value === n) || {}).label
    });
    return m.jsx(es, {
      isOpen: e,
      selected: n,
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function Nu(e) {
    e || ft("initialIsRequired"), Pn(e) || ft("initialType"), Eu(e) && ft("initialContent");
  }
  function Ru(e, t) {
  ...
  function Du(e) {
    ...
    var n = {
      current: e
    }, i = Vt(Fu)(n, t), r = Vt(zu)(n), a = Vt(dn.changes)(e), o = Vt(Mu)(n);
    function l() {
  ...
  function $u(e) {
    return e || qr("configIsRequired"), qu(e) || qr("configType"), e.urls ? (Vu(), {
      paths: {
  ...
  var Gu = Lu.create({
    ...
    reject: null,
    monaco: null
  }), qo = bu(Gu, 2), ln = qo[0], Fn = qo[1];
  function Yu(e) {
    var t = Wu.config(e), n = t.monaco, i = yu(t, [
      "monaco"
    ]);
    Fn(function(r) {
      return {
  ...
  function Qu() {
    ...
    if (!e.isInitialized) {
      if (Fn({
        isInitialized: true
      }), e.monaco) return e.resolve(e.monaco), ni(ii);
      if (window.monaco && window.monaco.editor) return $o(window.monaco), e.resolve(window.monaco), ni(ii);
      Xu(Ju, ep)(tp);
    }
    return ni(ii);
  }
  ...
  function ep(e) {
    ...
    }), n = Zu("".concat(t.config.paths.vs, "/loader.js"));
  ...
  var ii = new Promise(function(e, t) {
    return Fn({
      resolve: e,
      reject: t
    });
  ...
  var lp = op, sp = lp;
  function cp({ width: e, height: t, isEditorReady: n, loading: i, _ref: r, className: a, wrapperProps: o }) {
    return Ne.createElement("section", {
      ...
      ...o
    }, !n && Ne.createElement(sp, null, i), Ne.createElement("div", {
      ref: r,
      style: {
        ...ri.fullWidth,
        ...!n && ri.hide
  ...
  function hp({ original: e, modified: t, language: n, originalLanguage: i, modifiedLanguage: r, originalModelPath: a, modifiedModelPath: o, keepCurrentOriginalModel: l = false, keepCurrentModifiedModel: c = false, theme: s = "light", loading: u = "Loading...", options: p = {}, height: f = "100%", width: d = "100%", className: y, wrapperProps: k = {}, beforeMount: _ = Gt, onMount: C = Gt }) {
    let [E, T] = w.useState(false), [A, q] = w.useState(true), O = w.useRef(null), L = w.useRef(null), V = w.useRef(null), D = w.useRef(C), M = w.useRef(_), F = w.useRef(false);
    Wo(() => {
      let S = Vo.init();
    ...
    w.useEffect(() => {
      E && D.current(O.current, L.current);
    }, [
      E
    ]), w.useEffect(() => {
      !A && !E && x();
  ...
  var vp = xp, fn = /* @__PURE__ */ new Map();
  function yp({ defaultValue: e, defaultLanguage: t, defaultPath: n, value: i, language: r, path: a, theme: o = "light", line: l, loading: c = "Loading...", options: s = {}, overrideServices: u = {}, saveViewState: p = true, keepCurrentModel: f = false, width: d = "100%", height: y = "100%", className: k, wrapperProps: _ = {}, beforeMount: C = Gt, onMount: E = Gt, onChange: T, onValidate: A = Gt }) {
    let [q, O] = w.useState(false), [L, V] = w.useState(true), D = w.useRef(null), M = w.useRef(null), F = w.useRef(null), I = w.useRef(E), x = w.useRef(C), v = w.useRef(), S = w.useRef(i), z = vp(a), $ = w.useRef(false), X = w.useRef(false);
    Wo(() => {
      let W = Vo.init();
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var Mp = typeof Jn == "function" ? Jn : Jn.default, zp = "file-invalid-type", Fp = "file-too-large", Lp = "file-too-small", Bp = "too-many-files", Hp = function() {
  ...
  function Yo(e, t) {
    var n = e.type === "application/x-moz-file" || Mp(e, t);
    return [
      n,
      n ? null : Hp(t)
    ];
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var Ln = w.forwardRef(function(e, t) {
    var n = e.children, i = Rn(e, Jp), r = ud(i), a = r.open, o = Rn(r, Zp);
  ...
  function ud() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, t = ke(ke({}, tl), e), n = t.accept, i = t.disabled, r = t.getFilesFromEvent, a = t.maxSize, o = t.minSize, l = t.multiple, c = t.maxFiles, s = t.onDragEnter, u = t.onDragLeave, p = t.onDragOver, f = t.onDrop, d = t.onDropAccepted, y = t.onDropRejected, k = t.onFileDialogCancel, _ = t.onFileDialogOpen, C = t.useFsAccessApi, E = t.autoFocus, T = t.preventDropOnDocument, A = t.noClick, q = t.noKeyboard, O = t.noDrag, L = t.noDragEventsBubbling, V = t.onError, D = t.validator, M = w.useMemo(function() {
      ...
      k
    ]), v = w.useRef(null), S = w.useRef(null), z = w.useReducer(pd, Ai), $ = oi(z, 2), X = $[0], H = $[1], h = X.isFocused, W = X.isFileDialogActive, J = w.useRef(typeof window < "u" && window.isSecureContext && C && Xp()), g = function() {
    ...
    w.useEffect(function() {
      ...
      return !i && E && v.current && v.current.focus(), function() {
      };
    }, [
      v,
      E,
    ...
    var ne = w.useCallback(function(B) {
      ...
      B.preventDefault(), B.persist(), ae(B), Y.current = [].concat(nd(Y.current), [
        B.target
      ]), mn(B) && Promise.resolve(r(B)).then(function(P) {
        if (!(Nn(B) && !L)) {
          var b = P.length, j = b > 0 && $p({
            files: P,
            accept: M,
            minSize: o,
            maxSize: a,
      ...
      B.forEach(function(U) {
        var Z = Yo(U, M), re = oi(Z, 2), Pe = re[0], Ve = re[1], De = Qo(U, o, a), Fe = oi(De, 2), Ze = Fe[0], ee = Fe[1], ue = D ? D(U) : null;
      ...
      if (J.current) {
        ...
        window.showOpenFilePicker(B).then(function(P) {
          ...
          Yp(P) ? (x(P), H({
            type: "closeDialog"
          })) : Qp(P) ? (J.current = false, S.current ? (S.current.value = null, S.current.click()) : ne(new Error("Cannot open the file picker because the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API is not supported and no <input> was provided."))) : ne(P);
        });
        return;
      }
      S.current && (H({
      ...
      return function() {
        var B = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, P = B.refKey, b = P === void 0 ? "ref" : P, j = B.role, U = B.onKeyDown, Z = B.onFocus, re = B.onBlur, Pe = B.onClick, Ve = B.onDragEnter, De = B.onDragOver, Fe = B.onDragLeave, Ze = B.onDrop, ee = Rn(B, ed);
        return ke(ke(Ri({
          onKeyDown: $e(nt(U, ze)),
          onFocus: $e(nt(Z, qe)),
          onBlur: $e(nt(re, Ge)),
          onClick: we(nt(Pe, Ae)),
          onDragEnter: K(nt(Ve, _e)),
          onDragOver: K(nt(De, xe)),
          onDragLeave: K(nt(Fe, ve)),
          onDrop: K(nt(Ze, le)),
      ...
      return function() {
        var B = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, P = B.refKey, b = P === void 0 ? "ref" : P, j = B.onChange, U = B.onClick, Z = Rn(B, td), re = Ri({
          accept: M,
          multiple: l,
          type: "file",
          style: {
  ...
  const nl = w.createContext(null), Et = (e) => {
    ...
    return a ? m.jsx(Va, Object.assign({}, o, {
      children: m.jsx(lt, Object.assign({
        className: n,
        onClick: s,
        variant: "plain",
  ...
  Et.displayName = "CodeEditorControl";
  var We;
  (function(e) {
  ...
  const dd = (e) => {
    ...
    const [ve, me] = w.useState(t), [le, Te] = w.useState(false), [ze, qe] = w.useState(true), [Ge, Ae] = w.useState(false), we = w.useRef(null), $e = w.useRef(null), K = w.useRef(null), ae = w.useRef(() => {
      ...
      _ === "sizeToFit" && oe(), x && x(ee, ue), me(ee), v(ee);
    }, Ce = () => {
    ...
    w.useEffect(() => me(t), [
      t
    ]), w.useEffect(() => (document.addEventListener("keydown", B), ae.current = Ja(K.current, Ce, true), Ce(), () => {
      document.removeEventListener("keydown", B), ae.current();
    }), []);
    const P = (ee, ue) => {
      ee.addCommand(ue.KeyMod.Shift | ue.KeyCode.Tab, () => $e.current.focus()), Array.from(document.getElementsByClassName("monaco-editor")).forEach((he) => he.removeAttribute("role")), z(ee, ue), we.current = ee, _ === "sizeToFit" && oe();
    }, b = (ee) => {
      me(ee), v(ee);
      ...
      scrollBeyondLastLine: _ !== "sizeToFit",
      readOnly: D,
      cursorStyle: "line",
    ...
    return m.jsx(Ln, {
      ...
      children: ({ getRootProps: ee, getInputProps: ue, isDragActive: he, open: Ye }) => {
        const Dt = m.jsx("input", Object.assign({}, ue(), {
          ...
          tabIndex: 0,
          dir: "ltr",
          children: m.jsx(kp, Object.assign({
            height: _ === "100%" ? void 0 : _,
            width: xe,
            language: F,
            value: ve,
            options: De,
        ...
        return m.jsx("div", {
          className: N(Ie.codeEditor, D && Ie.modifiers.readOnly, (_ === "100%" ? true : A) && Ie.modifiers.fullHeight, e),
          ref: K,
          children: (M || u) && !ve ? m.jsxs("div", Object.assign({}, ee({
            onClick: (Hl) => Hl.stopPropagation()
          }), {
            className: N(Ie.codeEditorContainer, le && ec.modifiers.loading),
            children: [
              mr,
              m.jsx("div", {
  ...
  const bd = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u, wd = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u, kd = {};
  function Qr(e, t) {
    return (kd.jsx ? wd : bd).test(e);
  }
  const Cd = /[ \t\n\f\r]/g;
  function Od(e) {
  ...
  let Sd = 0;
  const te = wt(), je = wt(), Mi = wt(), R = wt(), ye = wt(), jt = wt(), Ue = wt();
  function wt() {
    return 2 ** ++Sd;
  }
  ...
  function Pd(e, t) {
    ...
    if (n.length > 4 && n.slice(0, 4) === "data" && Id.test(t)) {
      if (t.charAt(4) === "-") {
        const a = t.slice(5).replace(ea, Rd);
        i = "data" + a.charAt(0).toUpperCase() + a.slice(1);
      } else {
        const a = t.slice(4);
        if (!ea.test(a)) {
          let o = a.replace(Td, Nd);
...
`, s = "/", u = "*", p = "", f = "comment", d = "declaration";
    si = function(k, _) {
      ...
      function O(x) {
        var v = new Error(_.source + ":" + C + ":" + E + ": " + x);
        if (v.reason = x, v.filename = _.source, v.line = C, v.column = E, v.source = k, !_.silent) throw v;
      }
      function L(x) {
        var v = x.exec(k);
        if (v) {
      ...
      function M() {
        ...
        if (!(s != k.charAt(0) || u != k.charAt(1))) {
          ...
          var S = k.slice(2, v - 2);
          return E += 2, T(S), k = k.slice(v), E += 2, x({
            type: f,
            comment: S
          });
        }
  ...
  var Bd = Ld();
  const Hd = Mn(Bd), pl = dl("end"), nr = dl("start");
  function dl(e) {
    return t;
    function t(n) {
  ...
  const ir = {}.hasOwnProperty, $d = /* @__PURE__ */ new Map(), Vd = /[A-Z]/g, Ud = /* @__PURE__ */ new Set([
    "table",
    "tbody",
    "thead",
    "tfoot",
  ...
  function ml(e, t, n) {
    if (t.type === "element") return Kd(e, t, n);
    if (t.type === "mdxFlowExpression" || t.type === "mdxTextExpression") return Gd(e, t);
    if (t.type === "mdxJsxFlowElement" || t.type === "mdxJsxTextElement") return Qd(e, t, n);
    if (t.type === "mdxjsEsm") return Yd(e, t);
    if (t.type === "root") return Jd(e, t, n);
    if (t.type === "text") return Zd(e, t);
  }
  function Kd(e, t, n) {
    const i = e.schema;
    let r = i;
    t.tagName.toLowerCase() === "svg" && i.space === "html" && (r = tr, e.schema = r), e.ancestors.push(t);
    const a = gl(e, t.tagName, false), o = nf(e, t);
    let l = ar(e, t);
    return Ud.has(t.tagName) && (l = l.filter(function(c) {
      return typeof c == "string" ? !Od(c) : true;
  ...
  function Qd(e, t, n) {
    ...
    const a = t.name === null ? e.Fragment : gl(e, t.name, true), o = rf(e, t), l = ar(e, t);
  ...
  function nf(e, t) {
    ...
    for (r in t.properties) if (r !== "children" && ir.call(t.properties, r)) {
      const a = af(e, r, t.properties[r]);
      if (a) {
        const [o, l] = a;
        e.tableCellAlignToStyle && o === "align" && typeof l == "string" && Wd.has(t.tagName) ? i = l : n[o] = l;
      }
    }
    if (i) {
  ...
  function ar(e, t) {
    const n = [];
    let i = -1;
    const r = e.passKeys ? /* @__PURE__ */ new Map() : $d;
  ...
  function af(e, t, n) {
    const i = Pd(e.schema, t);
    if (!(n == null || typeof n == "number" && Number.isNaN(n))) {
      if (Array.isArray(n) && (n = i.commaSeparated ? yd(n) : Dd(n)), i.property === "style") {
        let r = typeof n == "object" ? n : of(e, String(n));
        return e.stylePropertyNameCase === "css" && (r = lf(r)), [
          "style",
          r
        ];
      }
      return [
        e.elementAttributeNameCase === "react" && i.space ? jd[i.property] || i.property : i.attribute,
        n
      ];
    }
  }
  ...
  function lf(e) {
    const t = {};
    let n;
    for (n in e) ir.call(e, n) && (t[sf(n)] = e[n]);
    return t;
  }
  function sf(e) {
    let t = e.replace(Vd, cf);
  ...
  function pf(e, t) {
    const n = uf, i = typeof n.includeImageAlt == "boolean" ? n.includeImageAlt : true, r = typeof n.includeHtml == "boolean" ? n.includeHtml : true;
    return xl(e, i, r);
  }
  function xl(e, t, n) {
    if (df(e)) {
  ...
  const rt = mt(/[A-Za-z]/), Ke = mt(/[\dA-Za-z]/), gf = mt(/[#-'*+\--9=?A-Z^-~]/);
  function Li(e) {
    return e !== null && (e < 32 || e === 127);
  }
  const Bi = mt(/\d/), xf = mt(/[\dA-Fa-f]/), vf = mt(/[!-/:-@[-`{-~]/);
  function Q(e) {
    return e !== null && e < -2;
  }
  function Be(e) {
  ...
  const yf = mt(new RegExp("\\p{P}|\\p{S}", "u")), bf = mt(/\s/);
  function mt(e) {
    return t;
    function t(n) {
  ...
  function Of(e) {
    ...
    function c(T) {
      if (i++, t.containerState._closeFlow) {
        t.containerState._closeFlow = void 0, r && E();
        ...
        return at(t.events, q + 1, 0, t.events.slice(A)), t.events.length = L, s(T);
      }
      return l(T);
    }
    function s(T) {
    ...
    function k(T) {
      if (T === null) {
        _(e.exit("chunkFlow"), true), C(0), e.consume(T);
        return;
      }
      return Q(T) ? (e.consume(T), _(e.exit("chunkFlow")), i = 0, t.interrupt = void 0, l) : (e.consume(T), k);
    }
    function _(T, A) {
      ...
      if (A && q.push(null), T.previous = a, a && (a.next = T), a = T, r.defineSkip(T.start), r.write(q), t.parser.lazy[T.start.line]) {
        ...
        at(t.events, V + 1, 0, t.events.slice(L)), t.events.length = O;
      }
    }
    function C(T) {
      let A = n.length;
  ...
  function _f(e, t) {
    ...
    for (; ++n < e.length; ) if (e[n][0] === "enter" && e[n][1].type === "attentionSequence" && e[n][1]._close) {
      for (i = n; i--; ) if (e[i][0] === "exit" && e[i][1].type === "attentionSequence" && e[i][1]._open && t.sliceSerialize(e[i][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
        ...
        ])) : u = 0, at(e, i - 1, n - i + 3, s), n = i + s.length - u - 2;
        break;
      }
    }
  ...
  function Tf(e, t, n) {
    ...
    function a(d) {
      return rt(d) ? (e.consume(d), o) : d === 64 ? n(d) : s(d);
    }
    function o(d) {
    ...
    function s(d) {
      return d === 64 ? (e.consume(d), u) : gf(d) ? (e.consume(d), s) : n(d);
    }
    function u(d) {
      return Ke(d) ? p(d) : n(d);
    }
  ...
  function Af(e, t, n) {
    ...
    function r(a) {
      return vf(a) ? (e.enter("characterEscapeValue"), e.consume(a), e.exit("characterEscapeValue"), e.exit("characterEscape"), t) : n(a);
    }
  }
  const wl = {
  ...
  function Df(e, t, n) {
    ...
    function s(p) {
      return p === 88 || p === 120 ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(p), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), a = 6, o = xf, u) : (e.enter("characterReferenceValue"), a = 7, o = Bi, u(p));
    }
    function u(p) {
      if (p === 59 && r) {
  ...
  function Mf(e, t, n) {
    ...
    function k(O) {
      return e.attempt(r, A, _)(O);
    }
    function _(O) {
      return e.enter("lineEnding"), e.consume(O), e.exit("lineEnding"), C;
    }
    function C(O) {
      return a > 0 && se(O) ? be(e, E, "linePrefix", a + 1)(O) : E(O);
    }
    function E(O) {
      return O === null || Q(O) ? e.check(fa, k, A)(O) : (e.enter("codeFlowValue"), T(O));
    }
    function T(O) {
      return O === null || Q(O) ? (e.exit("codeFlowValue"), E(O)) : (e.consume(O), T);
    }
    function A(O) {
  ...
  function Lf(e, t, n) {
    ...
    function o(s) {
      return s === null ? c(s) : Q(s) ? e.attempt(Ff, o, c)(s) : (e.enter("codeFlowValue"), l(s));
    }
    function l(s) {
  ...
  function kl(e) {
    ...
    for (; ++n < u.length; ) {
      ...
      if (i[0] === "enter") i[1].contentType && (Object.assign(t, Wf(u, n)), n = t[n], s = true);
    ...
    return at(e, 0, Number.POSITIVE_INFINITY, u.slice(0)), !s;
  }
  function Wf(e, t) {
    ...
    for (d = n; ++f < l.length; ) l[f][0] === "exit" && l[f - 1][0] === "enter" && l[f][1].type === l[f - 1][1].type && l[f][1].start.line !== l[f][1].end.line && (k = f + 1, _.push(k), d._tokenizer = void 0, d.previous = void 0, d = d.next);
    for (o.events = [], d ? (d._tokenizer = void 0, d.previous = void 0) : _.pop(), f = _.length; f--; ) {
      const C = l.slice(_[f], _[f + 1]), E = a.pop();
      c.push([
        E,
        E + C.length - 1
      ]), e.splice(E, 2, C);
  ...
  function Yf(e, t) {
    ...
    function r(l) {
      return l === null ? a(l) : Q(l) ? e.check(Kf, o, a)(l) : (e.consume(l), r);
    }
    function a(l) {
  ...
  function Cl(e, t, n, i, r, a, o, l, c) {
    ...
    function k(C) {
      return !u && (C === null || C === 41 || Be(C)) ? (e.exit("chunkString"), e.exit(l), e.exit(o), e.exit(i), t(C)) : u < s && C === 40 ? (e.consume(C), u++, k) : C === 41 ? (e.consume(C), u--, k) : C === null || C === 32 || C === 40 || Li(C) ? n(C) : (e.consume(C), C === 92 ? _ : k);
    }
    function _(C) {
  ...
  function dm(e, t, n) {
    ...
    function p(g) {
      return g === 33 ? (e.consume(g), f) : g === 47 ? (e.consume(g), a = true, k) : g === 63 ? (e.consume(g), r = 3, i.interrupt ? t : h) : rt(g) ? (e.consume(g), o = String.fromCharCode(g), _) : n(g);
    }
    function f(g) {
      return g === 45 ? (e.consume(g), r = 2, d) : g === 91 ? (e.consume(g), r = 5, l = 0, y) : rt(g) ? (e.consume(g), r = 4, i.interrupt ? t : h) : n(g);
    }
    function d(g) {
    ...
    function k(g) {
      return rt(g) ? (e.consume(g), o = String.fromCharCode(g), _) : n(g);
    }
    function _(g) {
      if (g === null || g === 47 || g === 62 || Be(g)) {
        const Y = g === 47, ce = o.toLowerCase();
        return !Y && !a && ha.includes(ce) ? (r = 1, i.interrupt ? t(g) : I(g)) : lm.includes(o.toLowerCase()) ? (r = 6, Y ? (e.consume(g), C) : i.interrupt ? t(g) : I(g)) : (r = 7, i.interrupt && !i.parser.lazy[i.now().line] ? n(g) : a ? E(g) : T(g));
      }
      return g === 45 || Ke(g) ? (e.consume(g), o += String.fromCharCode(g), _) : n(g);
    }
    function C(g) {
      return g === 62 ? (e.consume(g), i.interrupt ? t : I) : n(g);
    }
    function E(g) {
      return se(g) ? (e.consume(g), E) : M(g);
    }
    function T(g) {
      return g === 47 ? (e.consume(g), M) : g === 58 || g === 95 || rt(g) ? (e.consume(g), A) : se(g) ? (e.consume(g), T) : M(g);
    }
    function A(g) {
    ...
    function I(g) {
      return g === 45 && r === 2 ? (e.consume(g), z) : g === 60 && r === 1 ? (e.consume(g), $) : g === 62 && r === 4 ? (e.consume(g), W) : g === 63 && r === 3 ? (e.consume(g), h) : g === 93 && r === 5 ? (e.consume(g), H) : Q(g) && (r === 6 || r === 7) ? (e.exit("htmlFlowData"), e.check(cm, J, x)(g)) : g === null || Q(g) ? (e.exit("htmlFlowData"), x(g)) : (e.consume(g), I);
    }
    function x(g) {
      return e.check(um, v, J)(g);
    }
    function v(g) {
    ...
    function X(g) {
      ...
      return rt(g) && o.length < 8 ? (e.consume(g), o += String.fromCharCode(g), X) : I(g);
    }
    function H(g) {
  ...
  function gm(e, t, n) {
    ...
    function c(h) {
      return h === 33 ? (e.consume(h), s) : h === 47 ? (e.consume(h), q) : h === 63 ? (e.consume(h), T) : rt(h) ? (e.consume(h), V) : n(h);
    }
    function s(h) {
      return h === 45 ? (e.consume(h), u) : h === 91 ? (e.consume(h), a = 0, y) : rt(h) ? (e.consume(h), E) : n(h);
    }
    function u(h) {
    ...
    function k(h) {
      return h === null ? n(h) : h === 93 ? (e.consume(h), _) : Q(h) ? (o = k, $(h)) : (e.consume(h), k);
    }
    function _(h) {
    ...
    function E(h) {
      return h === null || h === 62 ? z(h) : Q(h) ? (o = E, $(h)) : (e.consume(h), E);
    }
    function T(h) {
    ...
    function D(h) {
      return h === 47 ? (e.consume(h), z) : h === 58 || h === 95 || rt(h) ? (e.consume(h), M) : Q(h) ? (o = D, $(h)) : se(h) ? (e.consume(h), D) : z(h);
    }
    function M(h) {
  ...
  function km(e, t, n) {
    ...
    function c(f) {
      return f === 40 ? e.attempt(xm, u, o ? u : p)(f) : f === 91 ? e.attempt(vm, u, o ? s : p)(f) : o ? u(f) : p(f);
    }
    function s(f) {
      return e.attempt(ym, u, p)(f);
    }
    function u(f) {
      return t(f);
    }
  ...
  function Am(e, t, n) {
    ...
    function s(d) {
      return e.enter("listItemMarker"), e.consume(d), e.exit("listItemMarker"), i.containerState.marker = i.containerState.marker || d, e.check(Bn, i.interrupt ? n : u, e.attempt(Nm, f, p));
    }
    function u(d) {
  ...
  function Dm(e, t, n) {
    ...
    function a(l) {
      return i.containerState.furtherBlankLines || !se(l) ? (i.containerState.furtherBlankLines = void 0, i.containerState.initialBlankLine = void 0, o(l)) : (i.containerState.furtherBlankLines = void 0, i.containerState.initialBlankLine = void 0, e.attempt(Rm, t, o)(l));
    }
    function o(l) {
  ...
  function qm(e) {
    const t = this, n = e.attempt(Bn, i, e.attempt(this.parser.constructs.flowInitial, r, be(e, e.attempt(this.parser.constructs.flow, r, e.attempt(Xf, r)), "linePrefix")));
    return n;
    function i(a) {
      if (a === null) {
        e.consume(a);
  ...
  const $m = {
    resolveAll: El()
  }, Vm = _l("string"), Um = _l("text");
  function _l(e) {
    return {
      resolveAll: El(e === "text" ? Wm : void 0),
      tokenize: t
    };
    function t(n) {
  ...
  function ih(e, t, n) {
    ...
    function p(F) {
      return o = Qe(o, F), _(), o[o.length - 1] !== null ? [] : (V(t, 0), s.events = lr(a, s.events, s), s.events);
    }
    function f(F, I) {
      return ah(d(F), I);
    }
    ...
    function V(F, I) {
      F.resolveAll && !a.includes(F) && a.push(F), F.resolve && at(s.events, I, s.events.length - I, F.resolve(s.events.slice(I), s)), F.resolveTo && (s.events = F.resolveTo(s.events, s));
    }
    function D() {
...
`;
  ...
  const ch = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
  function uh(e) {
    return e.replace(ch, ph);
  }
  function ph(e, t, n) {
    if (t) return t;
  ...
  function dh(e, t, n) {
    return typeof t != "string" && (n = t, t = void 0), fh(n)(lh(oh(n).document().write(sh()(e, t, true))));
  }
  function fh(e) {
    const t = {
      transforms: [],
    ...
    function X(b) {
      ...
      U.label = uh(j), U.identifier = Tt(j).toLowerCase();
    }
    function H() {
...
` : "", i = {};
  ...
  function Th(e, t, n) {
    const i = e.all(t), r = n ? Ih(n) : Pl(t), a = {}, o = [];
...
`
  ...
  const Nl = -1, Hn = 0, Jt = 1, An = 2, cr = 3, ur = 4, pr = 5, dr = 6, Rl = 7, Al = 8, ka = typeof self == "object" ? self : globalThis, qh = (e, t) => {
    ...
    return i;
  }, Ca = (e) => qh(/* @__PURE__ */ new Map(), e)(0), St = "", { toString: $h } = {}, { keys: Vh } = Object, Ht = (e) => {
    const t = typeof e;
    if (t !== "object" || !e) return [
      Hn,
      t
    ];
    const n = $h.call(e).slice(8, -1);
    switch (n) {
      case "Array":
        return [
          Jt,
  ...
  }, gn = ([e, t]) => e === Hn && (t === "function" || t === "symbol"), Uh = (e, t, n, i) => {
    const r = (o, l) => {
      const c = i.push(o) - 1;
      return n.set(l, c), c;
    }, a = (o) => {
      ...
      switch (l) {
        ...
        case An: {
          ...
          for (const f of Vh(o)) (e || !gn(Ht(o[f]))) && u.push([
            a(f),
            a(o[f])
          ]);
          return p;
    ...
    const i = [];
    return Uh(!(t || n), !!t, /* @__PURE__ */ new Map(), i)(e), i;
  ...
  function Kh(e) {
    const t = typeof e.options.clobberPrefix == "string" ? e.options.clobberPrefix : "user-content-", n = e.options.footnoteBackContent || Wh, i = e.options.footnoteBackLabel || Xh, r = e.options.footnoteLabel || "Footnotes", a = e.options.footnoteLabelTagName || "h2", o = e.options.footnoteLabelProperties || {
      className: [
        "sr-only"
      ]
    }, l = [];
    ...
    for (; ++c < e.footnoteOrder.length; ) {
      ...
      if (_ && _.type === "element" && _.tagName === "p") {
        const E = _.children[_.children.length - 1];
        E && E.type === "text" ? E.value += " " : _.children.push({
          type: "text",
          value: " "
        }), _.children.push(...y);
      } else u.push(...y);
...
`
  ...
  const Dl = function(e) {
    ...
    if (typeof e == "object") return Array.isArray(e) ? Gh(e) : Yh(e);
  ...
  function qn(e) {
    return t;
    function t(n, i, r) {
      return !!(Zh(n) && e.call(this, n, typeof i == "number" ? i : void 0, r || void 0));
    }
  }
  function Jh() {
    return true;
  ...
  const Ml = [], eg = true, Sa = false, tg = "skip";
  function ng(e, t, n, i) {
    let r;
    ...
    function l(c, s, u) {
      ...
      function f() {
        let d = Ml, y, k, _;
        if ((!t || a(c, s, u[u.length - 1] || void 0)) && (d = ig(n(c, u)), d[0] === Sa)) return d;
        if ("children" in c && c.children) {
          const C = c;
          if (C.children && d[0] !== tg) for (k = (i ? C.children.length : -1) + o, _ = u.concat(C); k > -1 && k < C.children.length; ) {
            const E = C.children[k];
            if (y = l(E, k, _)(), y[0] === Sa) return y;
  ...
  function zl(e, t, n, i) {
    let r, a, o;
    typeof t == "function" ? (a = void 0, o = t, r = n) : (a = t, o = n, r = i), ng(e, a, l, r);
    function l(c, s) {
      const u = s[s.length - 1], p = u ? u.children.indexOf(c) : void 0;
      return o(c, p, u);
    }
  }
  const qi = {}.hasOwnProperty, rg = {};
  function ag(e, t) {
    const n = t || rg, i = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), o = {
      ...Hh,
      ...n.handlers
    }, l = {
      all: s,
    ...
    function c(u, p) {
      ...
      if (l.options.passThrough && l.options.passThrough.includes(f)) {
        if ("children" in u) {
          const { children: k, ..._ } = u, C = Dn(_);
          return C.children = l.all(u), C;
        }
        return Dn(u);
      }
      return (l.options.unknownHandler || sg)(l, u, p);
    }
    function s(u) {
      const p = [];
      if ("children" in u) {
        ...
        for (; ++d < f.length; ) {
          const y = l.one(f[d], u);
          if (y) {
            if (d && f[d - 1].type === "break" && (!Array.isArray(y) && y.type === "text" && (y.value = _a(y.value)), !Array.isArray(y) && y.type === "element")) {
              const k = y.children[0];
              k && k.type === "text" && (k.value = _a(k.value));
            }
...
`
  ...
  function Ea(e, t) {
    const n = ag(e, t), i = n.one(e, void 0), r = Kh(n), a = Array.isArray(i) ? {
      type: "root",
      children: i
    } : i || {
      type: "root",
...
`
  ...
  function pg() {
    ...
    return di = function c() {
      var s, u, p, f, d, y, k = arguments[0], _ = 1, C = arguments.length, E = false;
      for (typeof k == "boolean" && (E = k, k = arguments[1] || {}, _ = 2), (k == null || typeof k != "object" && typeof k != "function") && (k = {}); _ < C; ++_) if (s = arguments[_], s != null) for (u in s) p = l(k, u), f = l(s, u), k !== f && (E && f && (a(f) || (d = r(f))) ? (d ? (d = false, y = p && r(p) ? p : []) : y = p && a(p) ? p : {}, o(k, {
        name: u,
        newValue: c(E, y, f)
      })) : typeof f < "u" && o(k, {
        name: u,
  ...
  class Fl {
    constructor(t) {
      ...
      t ? Vi(t) ? n = {
        path: t
      } : typeof t == "string" || Sg(t) ? n = {
        value: t
      } : n = t : n = {}, this.cwd = "cwd" in n ? "" : wg.cwd(), this.data = {}, this.history = [], this.messages = [], this.value, this.map, this.result, this.stored;
      let i = -1;
      for (; ++i < mi.length; ) {
        const a = mi[i];
    ...
    set basename(t) {
      gi(t, "basename"), hi(t, "basename"), this.path = it.join(this.dirname || "", t);
    }
    get dirname() {
      return typeof this.path == "string" ? it.dirname(this.path) : void 0;
    }
    set dirname(t) {
      Ia(this.basename, "dirname"), this.path = it.join(t || "", this.basename);
    }
    get extname() {
    ...
    set path(t) {
      Vi(t) && (t = Cg(t)), gi(t, "path"), this.path !== t && this.history.push(t);
    }
    get stem() {
      return typeof this.path == "string" ? it.basename(this.path, this.extname) : void 0;
    }
    set stem(t) {
      gi(t, "stem"), hi(t, "stem"), this.path = it.join(this.dirname || "", t + (this.extname || ""));
    }
    fail(t, n, i) {
  ...
  function hi(e, t) {
    if (e && e.includes(it.sep)) throw new Error("`" + t + "` cannot be a path: did not expect `" + it.sep + "`");
  }
  function gi(e, t) {
  ...
  class fr extends _g {
    constructor() {
      super("copy"), this.Compiler = void 0, this.Parser = void 0, this.attachers = [], this.compiler = void 0, this.freezeIndex = -1, this.frozen = void 0, this.namespace = {}, this.parser = void 0, this.transformers = fg();
    }
    copy() {
      const t = new fr();
      let n = -1;
    ...
    data(t, n) {
      return typeof t == "string" ? arguments.length === 2 ? (yi("data", this.frozen), this.namespace[t] = n, this) : Eg.call(this.namespace, t) && this.namespace[t] || void 0 : t ? (yi("data", this.frozen), this.namespace = t, this) : this.namespace;
    }
    freeze() {
    ...
    process(t, n) {
      ...
      function r(a, o) {
        ...
        i.run(c, l, function(u, p, f) {
          ...
          Ig(y) ? f.value = y : f.result = y, s(u, f);
        });
        function s(u, p) {
  ...
  function xn(e) {
    return Tg(e) ? e : new Fl(e);
  }
  function Tg(e) {
    return !!(e && typeof e == "object" && "message" in e && "messages" in e);
  }
  function Ig(e) {
    return typeof e == "string" || Pg(e);
  }
  function Pg(e) {
    return !!(e && typeof e == "object" && "byteLength" in e && "byteOffset" in e);
  }
  const Ng = "https://github.com/remarkjs/react-markdown/blob/main/changelog.md", Ra = [], Aa = {
    allowDangerousHtml: true
  }, Rg = /^(https?|ircs?|mailto|xmpp)$/i, Ag = [
    {
      from: "astPlugins",
  ...
  function Dg(e) {
    const t = Mg(e), n = zg(e);
    return Fg(t.runSync(t.parse(n), n), e);
  }
  function Mg(e) {
    ...
    return jg().use(hh).use(n).use(ug, i).use(t);
  }
  function zg(e) {
  ...
  function Fg(e, t) {
    const n = t.allowedElements, i = t.allowElement, r = t.components, a = t.disallowedElements, o = t.skipHtml, l = t.unwrapDisallowed, c = t.urlTransform || Lg;
    for (const u of Ag) Object.hasOwn(t, u.from) && ("" + u.from + (u.to ? "use `" + u.to + "` instead" : "remove it") + Ng + u.id, void 0);
    return zl(e, s), Xd(e, {
      Fragment: m.Fragment,
      components: r,
  ...
  function Lg(e) {
    ...
    return t === -1 || r !== -1 && t > r || n !== -1 && t > n || i !== -1 && t > i || Rg.test(e.slice(0, t)) ? e : "";
  }
  function Da(e) {
    return zn(e).with({
      g: fe.array()
  ...
  function Bg({ init: e, download: t, dopar: n }) {
  ...
  async function qg(e, t, n, i, r, a) {
    try {
      ...
      r > 0 && (o.max_tokens = r);
      const l = await e.chat.completions.create(o);
  ...
  async function $g(e, t, n) {
    return await ls(new Worker(new URL("/cloud-computer/spnl/assets/generate-worker-C-8I7YPm.js", import.meta.url), {
      ...
      initProgressCallback: Hg(t, n)
    });
  }
  async function Vg(e, t, n, i, r, a, o, l, c) {
    const s = Ui(e);
    console.log("gen messages", s);
    const u = t, p = `${u}.${c}`;
    p in bi || (console.log("Initializing engine", p), bi[p] = $g(u, a, o));
    const f = await bi[p];
    return qg(f, s, r, l, n, i);
  }
  function Ug() {
  }
...
`), i)).with({
      ...
      }), c = await Vg(o, t.defaultModel, r, a, n >= 0 ? Ug : t.emit, t.setProgressInit, t.setProgressDownload, l, n);
...
`), i)).with({
  ...
  function Wg({ runState: e, query: t, onComplete: n }) {
    const [i] = Wi("spnl.model.select", {
      defaultValue: ""
